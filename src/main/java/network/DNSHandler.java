...
public class DNSHandler implements Handler {
    ...
    private final Map<Integer, ClientHandler> attachments = new HashMap<>();
    ...
    public void sendToResolve(String domainName, ClientHandler handler) {
        try {
    ...
    public void read(SelectionKey key) throws IOException {
        if (resolverChannel.receive(readBuff) != null) {
            ...
            ClientHandler session = attachments.remove(response.getHeader().getID());
